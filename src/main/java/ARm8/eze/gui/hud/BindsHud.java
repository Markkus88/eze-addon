...
public class BindsHud extends HudElement {
    public static final HudElementInfo<BindsHud> INFO = new HudElementInfo<>(Addon.HUD_GROUP, "binds-hud", "Displays modules you've binded keys to.", BindsHud::new);

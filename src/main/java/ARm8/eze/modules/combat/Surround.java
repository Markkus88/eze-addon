...
import ARm8.eze.events.BlockUpdateEvent;
import ARm8.eze.utils.misc.SurroundUtils;
import ARm8.eze.utils.misc.TimerUtils;
import ARm8.eze.utils.world.BlockPosX;
import ARm8.eze.utils.world.Place;
...
public class Surround extends Module {
    ...
    public List<BlockPosX> getPositions(PlayerEntity player) {
        ...
        for (BlockPosX bp : SurroundUtils.getSphere(player.getBlockPos(), 3, 1)) {
    ...
    public void onTick(TickEvent.Post event) {
        ...
        ArrayList<BlockPos> boobies = SurroundUtils.getSurroundBlocks(mc.player);
        ...
        if (poses.isEmpty() || !block.found()) {
            if (SurroundUtils.isSurrounded(mc.player)) timer.reset();
            return;
        }

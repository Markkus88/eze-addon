package ARm8.addon.gui.servers;

import ARm8.addon.mixins.MultiplayerScreenAccessor;
import ARm8.addon.utils.server.IServerFinderDoneListener;
import ARm8.addon.utils.server.MServerInfo;
import ARm8.addon.utils.server.ServerPinger;
...
public class ServerFinderScreen extends WindowScreen implements IServerFinderDoneListener {
    ...
    private final WLabel scannedIpsLabel;

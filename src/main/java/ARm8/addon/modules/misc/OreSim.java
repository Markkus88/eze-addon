...
import ARm8.addon.events.ChunkPosDataEvent;
import ARm8.addon.events.PlayerRespawnEvent;
import ARm8.addon.events.SeedChangedEvent;
import ARm8.addon.utils.world.Ore;
import ARm8.addon.utils.seeds.Seed;
import ARm8.addon.utils.seeds.Seeds;
...
public class OreSim extends Module {
    ...
    public OreSim() {
        super(Addon.MISC, "ore-sim", "Xray on crack.");

...
public class XPThrower extends Module {
    ...
    public XPThrower() {
        super(Addon.COMBAT, "XP-thrower", "Throw XP bottles to repair your armor and tools.");
    }
    ...
    private boolean shouldWait() {
        ...
        if (allowDoubles.get()  && !ezeEntityUtils.isInHole(mc.player, allowDoubles.get(), ezeEntityUtils.BlastResistantType.Any)) return true;
